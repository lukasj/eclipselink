...
final class ReportQueryAdvancedOptionsDialog extends QueryAdvancedOptionsDialog {

    ReportQueryAdvancedOptionsDialog(MWReportQuery query, WorkbenchContext context) {
        super(query, context);
    }

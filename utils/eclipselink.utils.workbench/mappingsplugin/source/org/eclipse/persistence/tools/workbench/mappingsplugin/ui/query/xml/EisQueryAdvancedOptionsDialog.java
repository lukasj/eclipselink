 ...
 */
final class EisQueryAdvancedOptionsDialog extends QueryAdvancedOptionsDialog {

    public EisQueryAdvancedOptionsDialog(MWAbstractReadQuery query, WorkbenchContext context) {
        super(query, context);
    }

 ...
 */
public class Project60IOManager {
    ...
    public MWProject read(File projectFile, Preferences preferences) {
        return this.read(projectFile, preferences, FileNotFoundListener.NULL_INSTANCE);
    }

    public MWProject read(File projectFile, Preferences preferences, FileNotFoundListener listener) {
        return new Project60Reader(this, projectFile, preferences, listener).read();
    }
...
//        topLinkProject.addDescriptor(org.eclipse.persistence.tools.workbench.mappingsmodel.project.MWTransactionalProjectEjbPolicy.buildDescriptor());
...
//        topLinkProject.addDescriptor(org.eclipse.persistence.tools.workbench.mappingsmodel.descriptor.ejb.MWDescriptorEjbPolicy.buildDescriptor());

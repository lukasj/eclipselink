...
public class NoInteractionProject extends org.eclipse.persistence.sessions.Project {

  public NoInteractionProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
        ...
        login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetoone/keyonsource/eis/nointeraction/");
        setLogin(login);
  }

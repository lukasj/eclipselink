...
public class MapProject extends org.eclipse.persistence.sessions.Project {
  ...
  public MapProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
        ...
        login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/map/");
        setLogin(login);
  }

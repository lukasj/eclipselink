...
public class NoGroupingElementIndirectionProject extends org.eclipse.persistence.sessions.Project {

  public NoGroupingElementIndirectionProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
        ...
        login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nogroupingelement/indirection/");
        setLogin(login);
  }

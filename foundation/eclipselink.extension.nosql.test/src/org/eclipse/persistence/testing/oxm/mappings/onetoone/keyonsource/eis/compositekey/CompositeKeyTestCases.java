...
public class CompositeKeyTestCases extends EISMappingTestCases {

  private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetoone/keyonsource/eis/compositekey/writing/team_control.xml";
  private final static String XML_TEST_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetoone/keyonsource/eis/compositekey/writing/team.xml";
  ...
  public CompositeKeyTestCases(String name) throws Exception {
    super(name);

 ...
 */
public class GetPreUpdateSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPreUpdateSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(),
              "descriptor.getEventManager().setPreUpdateSelector(\"TestPreUpdate\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPreUpdateSelector() != null");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getEventManager().setPreUpdateSelector("TestPreUpdate");
    }
}

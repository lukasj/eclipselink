...
/**
 * Do the basic DeleteObjectTest except on a multiple table. The method of setting up the multiple tables
 * can be chosen by passing the amendment method name in the constructor.
 */
public class MultipleTableDeleteObjectTest extends org.eclipse.persistence.testing.framework.DeleteObjectTest {
    String amendmentMethodName;

    public MultipleTableDeleteObjectTest(Object originalObject, String amendmentMethodName) {
        super(originalObject);
        this.amendmentMethodName = amendmentMethodName;
        setName("MultipleTableDeleteObjectTest(" + amendmentMethodName + "," + originalObject + ")");
    }

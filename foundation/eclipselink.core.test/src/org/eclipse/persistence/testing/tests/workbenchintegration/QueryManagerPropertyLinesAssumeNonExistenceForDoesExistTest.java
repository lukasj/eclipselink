 ...
 */
public class QueryManagerPropertyLinesAssumeNonExistenceForDoesExistTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public QueryManagerPropertyLinesAssumeNonExistenceForDoesExistTest() {
        ...
        setDescription("Test addQueryManagerPropertyLines method -> shouldAssumeNonExistenceForDoesExist()");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getQueryManager().assumeNonExistenceForDoesExist();
    }
}

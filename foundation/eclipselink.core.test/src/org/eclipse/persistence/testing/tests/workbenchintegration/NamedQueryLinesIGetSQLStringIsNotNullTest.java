 ...
 */
public class NamedQueryLinesIGetSQLStringIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public NamedQueryLinesIGetSQLStringIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(),
              "namedQuery0.setSQLString(\"testString\");");

 ...
 */
public class ShouldBeReadOnlyTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldBeReadOnlyTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(),
              "descriptor.setReadOnly();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldBeReadOnly");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.setReadOnly();
    }
}

 ...
 */
public class GetPostUpdateSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPostUpdateSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(),
              "descriptor.getEventManager().setPostUpdateSelector(\"TestPostUpdate\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPostUpdateSelector() != null");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getEventManager().setPostUpdateSelector("TestPostUpdate");
    }
}

...
/**
 *  This test system uses the Inheritance test system to test the integration
 ...
 *  @author Edwin Tang
 */
public class InheritanceWorkbenchIntegrationSubSystem extends InheritanceWorkbenchIntegrationSystem {

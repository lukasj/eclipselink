 ...
 */
public class ReadAllCompletelyBatchedEmployeeTest extends PerformanceTest {
    public ReadAllCompletelyBatchedEmployeeTest() {
        setDescription("This tests the performance of read-all queries with batch reading.");
    }

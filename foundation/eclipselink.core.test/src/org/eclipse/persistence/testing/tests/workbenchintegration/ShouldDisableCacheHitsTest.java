 ...
 */
public class ShouldDisableCacheHitsTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldDisableCacheHitsTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(),
              "descriptor.disableCacheHits();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldDisableCacheHits");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.disableCacheHits();
    }
}

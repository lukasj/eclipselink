 ...
 */
public class ShouldUseHardCacheWeakIdentityMapTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldUseHardCacheWeakIdentityMapTest() {
        ...
        setDescription("Test addDescriptorPropertyLines method -> the shouldUseHardCacheWeakIdentityMap");
    }

    protected void setup() {
        getSession().getIdentityMapAccessor().initializeAllIdentityMaps();
        descriptorToModify = project.getDescriptors().get(Employee.class);
        descriptorToModify.useHardCacheWeakIdentityMap();
    }
}

...
public class MemoryQueryAcrossOneToManyMapping2 extends TestCase {
    ...
    public MemoryQueryAcrossOneToManyMapping2() {
        super();
    }
    ...
    public void setup() {
        ...
        queryAll.setSelectionCriteria(new ExpressionBuilder().anyOf("managedEmployees").anyOf("phoneNumbers").get("areaCode").equal("613"));
    ...
    public void test() {
        ...
        Expression exp1 = bldr.anyOf("managedEmployees").get("lastName").equal("Way");
        Expression exp2 = bldr.anyOf("phoneNumbers").get("areaCode").equal("613");

...
public class LoadAndSaveMimeTypeOnXSDManyTestCases extends LoadAndSaveTestCases {
    public LoadAndSaveMimeTypeOnXSDManyTestCases(String name) {
        super(name);
    }
    ...
    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.sdo.helper.xmlhelper.loadandsave.LoadAndSaveMimeTypeOnXSDManyTestCases" };

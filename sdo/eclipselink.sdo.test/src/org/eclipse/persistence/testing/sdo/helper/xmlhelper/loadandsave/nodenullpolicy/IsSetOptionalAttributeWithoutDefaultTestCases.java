...
public abstract class IsSetOptionalAttributeWithoutDefaultTestCases extends LoadAndSaveTestCases {
     ...
     */
    public IsSetOptionalAttributeWithoutDefaultTestCases(String name) {
        super(name);
    }
...
//        assertFalse(isSet);
    ...
    public void registerTypes() {
        ...
        // add id property
        DataObject employeeIDProperty = addProperty(employeeTypeDO, ID_NAME, intType, false, false, false);
        //employeeIDProperty.set("nullable", false);
        //employeeIDProperty.set("default", 10);

        // add firstname property
        DataObject employeeFirstnameProperty = addProperty(employeeTypeDO, FIRSTNAME_NAME, stringType, false, false, false);
...
//        employeeTaskProperty.setBoolean("many", true);
        ...
        DataObject employeeLastnameProperty = addProperty(employeeTypeDO, LASTNAME_NAME, stringType, false, false, false);

...
public class XMLElementRefAttachmentEmptyTestCases extends JAXBWithJSONTestCases {

    private final static String XML_RESOURCE = "org/eclipse/persistence/testing/jaxb/xmlelementref/attachment/employeeEmptyAttachment.xml";
    private final static String JSON_RESOURCE = "org/eclipse/persistence/testing/jaxb/xmlelementref/attachment/employeeEmptyAttachment.json";

    public XMLElementRefAttachmentEmptyTestCases(String name) throws Exception {
        super(name);
    ...
    protected Object getControlObject() {
        ...
        employee.ref1  = new JAXBElement(new QName("fooA"), byte[].class, new byte[0]);

        employee.ref2 = new ArrayList<JAXBElement>();
        employee.ref2.add(new JAXBElement(new QName("fooC"), String.class, ""));
        employee.ref2.add(new JAXBElement(new QName("fooB"), Byte[].class, new byte[0]));
        employee.ref2.add(new JAXBElement(new QName("fooB"), Byte[].class, new byte[0]));
        employee.ref2.add(new JAXBElement(new QName("fooC"), String.class, ""));
        return employee;
    }

 ...
 * Positive test.
 */
public class XmlAccessorTypePackageClassOverrideTestCases extends JAXBWithJSONTestCases {
    ...
    public Map getProperties(){
        ...
        metadataSourceMap.put("org.eclipse.persistence.testing.jaxb.externalizedmetadata.xmlaccessortype.packagelevel.classoverride", new StreamSource(inputStream));
    ...
    public void testInstanceDocValidation() throws Exception {
        InputStream schema = ClassLoader.getSystemResourceAsStream("org/eclipse/persistence/testing/jaxb/externalizedmetadata/xmlaccessortype/packagelevel/classoverride/employee-package-classoverride.xsd");
    ...
    public void testSchemaGen() throws Exception {
        ...
        InputStream is = ClassLoader.getSystemResourceAsStream("org/eclipse/persistence/testing/jaxb/externalizedmetadata/xmlaccessortype/packagelevel/classoverride/employee-package-classoverride.xsd");

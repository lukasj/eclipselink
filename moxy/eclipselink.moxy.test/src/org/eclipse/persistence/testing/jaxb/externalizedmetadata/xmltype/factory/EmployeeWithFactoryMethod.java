...
public class EmployeeWithFactoryMethod {
    ...
    public EmployeeWithFactoryMethod(boolean flag) {
        if (flag) {
            id = -2;
        }
    }
    ...
    public boolean equals(Object o) {
        EmployeeWithFactoryMethod obj;
        try {
            obj = (EmployeeWithFactoryMethod) o;
    ...
    public static EmployeeWithFactoryMethod getNewEmployee() {
        EmployeeWithFactoryMethod emp = new EmployeeWithFactoryMethod(false);

...
public class CompositeElementKeyWithGroupingEmptyTestCases extends KeyBasedMappingTestCases {
    ...
    public CompositeElementKeyWithGroupingEmptyTestCases(String name) throws Exception {
        super(name);

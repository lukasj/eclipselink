 ...
 * UC 8-9 and 11.3
 */
public class CompositeObjectNullPolicyAbsentIsSetAbsentTrueTestCases extends XMLWithJSONMappingTestCases {
    private final static String XML_RESOURCE = //
        "org/eclipse/persistence/testing/oxm/mappings/compositeobject/nillable/CompositeObjectNullPolicyAbsentIsSetAbsentTrue.xml";
    private final static String JSON_RESOURCE = //
        "org/eclipse/persistence/testing/oxm/mappings/compositeobject/nillable/CompositeObjectNullPolicyAbsentIsSetAbsentTrue.json";

    public CompositeObjectNullPolicyAbsentIsSetAbsentTrueTestCases(String name) throws Exception {
        super(name);

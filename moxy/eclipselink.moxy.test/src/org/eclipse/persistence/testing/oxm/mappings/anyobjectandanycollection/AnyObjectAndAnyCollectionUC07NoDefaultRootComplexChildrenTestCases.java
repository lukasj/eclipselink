 ...
 */
public class AnyObjectAndAnyCollectionUC07NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc07.xml";
    ...
    public AnyObjectAndAnyCollectionUC07NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);

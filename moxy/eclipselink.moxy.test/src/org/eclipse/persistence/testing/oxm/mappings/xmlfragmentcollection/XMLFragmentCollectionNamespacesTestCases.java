...
public class XMLFragmentCollectionNamespacesTestCases extends XMLMappingTestCases {
    public XMLFragmentCollectionNamespacesTestCases(String name) throws Exception {
        super(name);
    ...
    public Object getControlObject() {
        ...
        try {
            ...
            Document doc = builder.parse(getClass().getClassLoader().getResourceAsStream("org/eclipse/persistence/testing/oxm/mappings/xmlfragmentcollection/sub_element_namespaces.xml"));
    ...
    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.oxm.mappings.xmlfragmentcollection.XMLFragmentCollectionNamespacesTestCases" };
